...
export function SlimPageHeader({ title, description }: SlimPageHeaderProps) {
  return (
    <section className="flex min-h-[180px] flex-col items-center justify-center border-b border-zinc-100 bg-zinc-100 py-16 text-center transition-colors duration-300 dark:border-zinc-900 dark:bg-[#0b1322] md:py-20">
